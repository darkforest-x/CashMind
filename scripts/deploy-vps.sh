...
ssh "${SSH_OPTS[@]}" "$SSH_TARGET" \
  "VPS_DIR='$VPS_DIR' VPS_REPO='$VPS_REPO' VPS_BRANCH='$VPS_BRANCH' VPS_PROJECT_NAME='$VPS_PROJECT_NAME' \
   ...
   SHORTCUT_TOKEN='$SHORTCUT_TOKEN' APP_ACCESS_TOKEN='$APP_ACCESS_TOKEN' SETUP_TOKEN='$SETUP_TOKEN' \
   VITE_API_BASE_URL='$VITE_API_BASE_URL' VPS_DOMAIN='$VPS_DOMAIN' \
...
APP_ACCESS_TOKEN="${APP_ACCESS_TOKEN:-$(read_env_value APP_ACCESS_TOKEN)}"
SHORTCUT_TOKEN="${SHORTCUT_TOKEN:-$(read_env_value SHORTCUT_TOKEN)}"
SETUP_TOKEN="${SETUP_TOKEN:-$(read_env_value SETUP_TOKEN)}"

{
  echo "HOST=$VPS_HOST_BIND"
  echo "PORT=$VPS_PORT"
  echo "GEMINI_API_KEY=$GEMINI_API_KEY"
  [ -n "$APP_ACCESS_TOKEN" ] && echo "APP_ACCESS_TOKEN=$APP_ACCESS_TOKEN"
  [ -n "$SHORTCUT_TOKEN" ] && echo "SHORTCUT_TOKEN=$SHORTCUT_TOKEN"
  [ -n "$SETUP_TOKEN" ] && echo "SETUP_TOKEN=$SETUP_TOKEN"
